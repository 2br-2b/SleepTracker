...
fun NetworkAiSettingsScreen(
    ...
    val aiModel by userPreferencesRepository.aiModel.collectAsState("gpt-4o-mini")
    val aiApiKey by userPreferencesRepository.aiApiKey.collectAsState("")
    val aiBaseUrl by userPreferencesRepository.aiBaseUrl.collectAsState("https://api.openai.com/v1")
    ...
    var draftModel by remember { mutableStateOf("gpt-4o-mini") }
    var draftApiKey by remember { mutableStateOf("") }
    var draftBaseUrl by remember { mutableStateOf("https://api.openai.com/v1") }
    ...
    Scaffold(topBar = { TopAppBar(title = { Text("Network & AI Settings") }) }) { innerPadding ->
        Column(
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                    ...
                    SettingToggleRow(
                        ...
                        description = "AI is routed through Koog and is automatically disabled when networking is off.",
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                    Text("Koog model configuration", style = MaterialTheme.typography.titleMedium)
                    Text(
                        "These values are for future AI integrations. Nothing is sent unless AI/network features are enabled and used.",
                        ...
                        Row(
                            modifier = Modifier
                                ...
                                .selectable(
                                    ...
                                    enabled = networkEnabled,
                                    onClick = { draftProvider = provider }
                                ),
